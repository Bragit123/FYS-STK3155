...
plt.figure()
plt.title(f"Mean square error for Ridge regression with polynomial degree {deg}.", fontsize=20)
...
plt.savefig("../Figures/MSERidge.pdf", bbox_inches='tight')

plt.figure()
plt.title(f"R2-values for Ridge regression with polynomial degree {deg}.", fontsize=20)
...
plt.xticks(fontsize=20)
plt.legend(fontsize=20)
plt.savefig("../Figures/R2Ridge.pdf", bbox_inches='tight')
